...
class AdminPanelController extends Controller
{
    ...
    {
        return view('AdminPanel.profileSettings.my-profile',[
            'active' => 'my-profile',
    ...
    {
        return view('AdminPanel.profileSettings.my-password',[
            'active' => 'my-password',
    ...
    public function notificationDetails($id)
    {
        ...
        if (in_array($Notification['data']['type'], ['newClient'])) {
            return redirect()->route('admin.clientUsers.edit',['id'=>$Notification['data']['linked_id']]);
        }
        return redirect()->back();
    }
