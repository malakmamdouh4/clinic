                    ...
                    {{Form::open(['files'=>'true','class'=>'validate-form'])}}
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-12 col-sm-3 mb-1">
                                ...
                                {{Form::select('role',getRolesList(session()->get('Lang'),'id',null),$user->role,['id'=>'role','class'=>'form-control selectpicker','data-live-search'=>'true'])}}
                                <!-- {{Form::select('role',$roles,$user->role,['id'=>'role','class'=>'form-control selectpicker','data-live-search'=>'true'])}} -->
